...
const PartnerPageShell = ({ themeKey = 'corporate', children }) => {
  ...
  return (
    <div className="rahini-unified-page min-h-screen overflow-x-hidden bg-[#F8FBFF] font-poppins flex flex-col">
      ...
      <main className="page-content relative flex-1 flex flex-col justify-start">
        ...
        <section className="hero relative pb-10 flex-1 flex flex-col justify-start bg-transparent">

          {/* Rahini unified animated atmosphere — same surface as Home */}
          <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
            <div className="absolute top-[18%] left-[12%] w-[520px] h-[360px] rounded-full bg-emerald-200/20 blur-[110px] animate-[rahiniFormFloat_14s_ease-in-out_infinite_alternate]" />
            <div className="absolute top-[28%] right-[8%] w-[560px] h-[380px] rounded-full bg-sky-200/20 blur-[120px] animate-[rahiniFormFloat_18s_ease-in-out_infinite_alternate-reverse]" />
            <div className="absolute bottom-[4%] left-[40%] w-[500px] h-[320px] rounded-full bg-violet-200/10 blur-[120px] animate-[rahiniFormFloat_20s_ease-in-out_infinite_alternate]" />
          </div>
